...
description: This guide will walk you through the process of creating a custom UI integration for @dual-autoform/react. By following these steps, you’ll be able to use AutoForm with your preferred UI library or custom components.
---

import { Accordion, Accordions } from "@/components/accordion";

This guide will walk you through the process of creating a custom UI integration for @dual-autoform/react. By following these steps, you'll be able to use AutoForm with your preferred UI library or custom components.

<div className='fd-steps [&_h2]:fd-step'>

## Set up the project

You can create your integration as a custom npm package (e.g. "@dual-autoform/custom-ui") or as part of your existing project. For this guide, we'll create a new npm package.
...
```bash
npm install @dual-autoform/react react react-hook-form @hookform/resolvers
```
...
You can take a look at existing implementations like "@dual-autoform/mui" for inspiration. Here's an example of how to implement these components with pure HTML:
...
`inputProps` contains props from `fieldConfig.inputProps`. React Hook Form custom field components should use `useController({ name: id })` from `react-hook-form` to connect the component to the active field.
...
Create a new file called `src/AutoForm.tsx`. This will wrap the base `AutoForm` component from `@dual-autoform/react` and provide your custom UI components:

```tsx
// src/AutoForm.tsx
// Use the `tanstack-form` subpath when building the TanStack variant.
...
To use your custom UI integration in a project, install it alongside @dual-autoform/react or use the integration in your project directly

```bash
npm install @dual-autoform/react @dual-autoform/custom-ui
```

Then, in your React component:

```tsx
import { AutoForm } from "@dual-autoform/custom-ui/react-hook-form";
...
By following these steps, you've created a custom UI integration for @dual-autoform/react that can be used with your preferred UI components or library. You can further customize the components and add more field types as needed for your specific use case.
