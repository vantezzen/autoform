...
> **Need deeper control?** If the package API isn't enough, install the full React Hook Form adapter source directly into your project and edit it freely:
> ```bash
> npx shadcn@latest add https://raw.githubusercontent.com/adityacodepublic/autoform/refs/heads/acp-package/packages/shadcn/registry/autoform-react-rhf.json
> ```
> Files land in `lib/autoform/react/`. Change anything — field rendering, resolver logic, array/object handling — without being bound by the package's public API.
