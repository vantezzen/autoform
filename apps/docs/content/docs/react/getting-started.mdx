...
This page documents AutoForm's React Hook Form adapter. For the TanStack Form adapter, see [TanStack Form](/docs/tanstack/getting-started).
...
Use `import { AutoForm } from "@/components/ui/autoform/react-hook-form"` to import the component. If you want to use another schema library, update the `/components/ui/autoform/utils.ts` file.
