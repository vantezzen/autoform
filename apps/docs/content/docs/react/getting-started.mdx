...
<ModeTab command="@autoform/react react-hook-form @hookform/resolvers" />
...
<ModeTab
  mode="cli"
  command="shadcn@latest add https://raw.githubusercontent.com/vantezzen/autoform/refs/heads/main/packages/shadcn/registry/autoform-rhf.json"
/>
