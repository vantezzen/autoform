...
For shared source definitions, see [`packages/react/src/types.ts`](https://github.com/vantezzen/autoform/tree/main/packages/react/src/types.ts). For the TanStack adapter, see [`packages/react/src/tanstack-form`](https://github.com/vantezzen/autoform/tree/main/packages/react/src/tanstack-form).
