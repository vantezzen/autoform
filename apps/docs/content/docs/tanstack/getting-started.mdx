...
<ModeTab
  mode="cli"
  command="shadcn@latest add https://raw.githubusercontent.com/adityacodepublic/autoform/refs/heads/acp-package/packages/shadcn/registry/autoform-tanstack.json"
/>
...
When creating custom field components for the TanStack adapter, use `useFieldContext` from `@acp-autoform/react/tanstack-form`. See [customization](/docs/tanstack/customization#connecting-custom-fields-to-tanstack-form).
