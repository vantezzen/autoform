...
| Access form data, methods and state inside AutoForm children | [`useFormContext`](https://tanstack.com/form/latest/docs/framework/react/guides/form-composition#pre-bound-form-components) from `@dual-autoform/react/tanstack-form` with [`form.Subscribe`](https://tanstack.com/form/latest/docs/framework/react/guides/reactivity#formsubscribe) or [`useStore`](https://tanstack.com/form/latest/docs/framework/react/guides/reactivity#usestore) |
| Connect a custom input field, access its methods and state   | [`useFieldContext`](https://tanstack.com/form/latest/docs/framework/react/guides/form-composition#pre-bound-field-components) from `@dual-autoform/react/tanstack-form`                                                                                                                                                                                                                |
| Control the form from a parent component                     | Create a form with [`useAppForm`](https://tanstack.com/form/latest/docs/framework/react/guides/form-composition#custom-form-hooks) from `@dual-autoform/react/tanstack-form` and pass it to `formControl` prop                                                                                                                                                                         |
