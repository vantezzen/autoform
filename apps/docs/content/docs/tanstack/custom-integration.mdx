...
If your integration supports both React Hook Form and TanStack Form, keep shared wrapper UI components common, but provide adapter-specific field components or an internal adapter binding for each entry. TanStack field components use `useFieldContext`; React Hook Form field components should use `useController`.
