...
For binding field components, use `useFieldContext` from `@acp-autoform/react/tanstack-form`.
...
[Shadcn fields](https://github.com/adityacodepublic/autoform/tree/tanstack-integration/packages/shadcn/src/components/ui/autoform/components),
[MUI fields](https://github.com/adityacodepublic/autoform/tree/tanstack-integration/packages/mui/src/components),
[Mantine fields](https://github.com/adityacodepublic/autoform/tree/tanstack-integration/packages/mantine/src/components) and
[Ant fields](https://github.com/adityacodepublic/autoform/tree/tanstack-integration/packages/ant/src/components).
...
**Custom Validator**: To replace AutoForm's default validator, create an external form with `useAppForm` from "@acp-autoform/react/tanstack-form". Add your own validator and pass it to `formControl`:
...
import { AutoForm, useAppForm } from "@acp-autoform/react/tanstack-form";
...
<ModeTab
  mode="cli"
  command="npx shadcn@latest add https://raw.githubusercontent.com/adityacodepublic/autoform/refs/heads/acp-package/packages/shadcn/registry/autoform-react-tanstack.json"
/>
