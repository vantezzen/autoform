...
Import `fieldConfig` from your schema package: [@autoform/zod](/docs/schema-providers/zod#field-configuration), [@autoform/yup](/docs/schema-providers/yup#field-configuration), or [@autoform/joi](/docs/schema-providers/joi#field-configuration).
