...
- Remove the root `@dual-autoform/mantine` export. Import AutoForm from an adapter-specific path instead: `@dual-autoform/mantine/react-hook-form` or `@dual-autoform/mantine/tanstack-form`.
