...
- Remove the root `@dual-autoform/mui` export. Import AutoForm from an adapter-specific path instead: `@dual-autoform/mui/react-hook-form` or `@dual-autoform/mui/tanstack-form`.
