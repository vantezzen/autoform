...
- Remove the deprecated `onFormInit` prop from React Hook Form and TanStack Form AutoForm implementations. Use an external form control via `formControl` when code needs direct access to the form instance.
